...
現在のローカル開発バージョンは `0.26.2`、「V1移行準備」です。V0.26.1までの中核機能を変更せず、Issue・Milestone・ロードマップ・検証記録を公開状態へ整合し、クリーン環境E2EでV1.0.0候補としての配布品質を確認します。クリーンアンインストールの詳細は[設計文書](docs/architecture/clean-uninstall.md)を参照してください。
