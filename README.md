...
現在のローカル開発バージョンは `0.26.1`、「クリーンアンインストール」です。V0.26.0までの累積機能に加え、現在の設定、SQLite DB、戦績、録画、ログ、キュー、バックアップ、エクスポート、アプリから導入したFFmpegを一括削除できます。詳細は[クリーンアンインストール設計](docs/architecture/clean-uninstall.md)を参照してください。
