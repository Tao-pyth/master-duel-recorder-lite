...
V0.2.0からV0.16.0までの中核機能が完了しても、自動ではV1.0.0へ更新しません。全完了条件を確認したうえで、ユーザーが明示的に「V1.0.0に変更せよ」と依頼した場合のみ更新します。対戦ログの編集・エクスポートとYouTube連携・アップロードはV0.16.0以降の候補として別途計画します。
