...
完了条件: 単一状態機械、イベント別評価、診断、通知が統合され、SHA-256固定済み超横長コーパス14本のオフライン評価、初期3戦・10戦連続の実戦E2E、Ruff、全テスト、両EXE、Windows CIが成功すること。1920x1080の最新実動画不足は公開時の既知リスクとして明記する。
