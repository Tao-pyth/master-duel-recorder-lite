...
- V0.23.0の結果判定回帰修正と実戦集計CLIを含め、Ruff、単体・統合テスト424件（skip 2件）、CLI/GUI EXEビルドと両EXEのV0.25.0隔離スモークを通過した
- 最新候補GUIの初期3戦で、勝利した第3戦を決着前の攻撃演出で敗北と誤確定する早期停止を検出し、敗北を4/5フレーム合意へ変更した
- 実戦集計CLIへ結果停止後の盤面継続検査を追加し、旧集計の3/3合格を2/3合格・第3戦不合格へ訂正した
- ローカルCLI EXE SHA-256: `5F32B31E08055102D843141A260D7718C24996A83EC8D367E698B49037856598`
- ローカルGUI EXE SHA-256: `81E9F3ABDF69D5AB1A2379B5C1F18AC7A0E9728B19DE424BBA616353B7062277`
