...
- V0.23.0の結果判定回帰修正と実戦集計CLIを含め、Ruff、単体・統合テスト426件（skip 2件）、CLI/GUI EXEビルドと両EXEのV0.25.0隔離スモークを通過した
- 最新候補GUIの初期3戦で、勝利した第3戦を決着前の攻撃演出で敗北と誤確定する早期停止を検出し、敗北を4/5フレーム合意へ変更した
- 実戦集計CLIへ結果停止後の盤面継続検査を追加し、旧集計の3/3合格を2/3合格・第3戦不合格へ訂正した
- ローカルCLI EXE SHA-256: `7B1E9C1951FC27817DAFC59ACE681CBE379D4EF3E807D2F3B5AF94CDEEA6C36A`
- ローカルGUI EXE SHA-256: `995F46842AC4943FF60709C342621AEE54B6068B891C7719FEA7F716CB65F4A8`
