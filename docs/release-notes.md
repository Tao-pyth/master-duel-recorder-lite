...
- V0.23.0の結果判定回帰修正と実戦集計CLIを含め、Ruff、単体・統合テスト423件（skip 2件）を通過した。CLI/GUI EXEビルドと両EXEのV0.25.0隔離スモークは修正版で再検証する
- 最新候補GUIの初期3戦で、勝利した第3戦を決着前の攻撃演出で敗北と誤確定する早期停止を検出し、敗北を4/5フレーム合意へ変更した
- 実戦集計CLIへ結果停止後の盤面継続検査を追加し、旧集計の3/3合格を2/3合格・第3戦不合格へ訂正した
- ローカルCLI EXE SHA-256: `46067A4B9F736CDED00DF05628A53AF5F3CEC19A273F38F68B68C41F68807F6F`
- ローカルGUI EXE SHA-256: `F493D0E88EBA89358DB20EE30D327C15CEDCF8CBC5369539BE07445594F4281D`
