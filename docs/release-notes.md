...
- Ruff、単体・統合テスト410件（skip 2件）、CLI/GUI EXEビルド、両EXEのV0.25.0隔離スモークを通過した
- ローカルCLI EXE SHA-256: `8BB9791AFB8BD3CCC03B85801C3A7ECBD0A656975CB037562CBF909A3B6EBE62`
- ローカルGUI EXE SHA-256: `64A80FFED5683FD3650285971C970E554AFB553BFD84FDF2D73E54AFD2448DE6`
...
- 提供動画14本の再評価とV0.23.0 EXEでの初期3戦・10戦連続試験が未達のため、タグ・Release・`main` pushは保留する
